...
### 공백 채색
- 특정 영역의 공백을 불투명으로 마킹하여 하위 레이어 차단
- 채색/제거 모드 + 시각적 표시 (노란색)

### 도트 문자 입력
- 스페이스바를 누를 때마다 좁은 공백 → 넓은 공백으로 순환 교체
- AA에서 미세 간격 조정에 필수
...
### 팔레트
- 자주 사용하는 AA 문자를 팔레트에 등록
- 클릭으로 활성 레이어의 커서 위치에 삽입
